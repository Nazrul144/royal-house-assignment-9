        ...
        <div className='bg-gradient-to-r from-indigo-100 cyan-500 via-purple-100 to-pink-100'>
            ...
            <div className='grid grid-cols-10 gap-4 mt-44 ml-4 lg:mt-16'>
                ...
                <div  className='col-span-8 '>
                    ...
                    <p className="lg:py-6 lg:px-8 font-poppins font-medium text-xl text-justify mt-24 animate__animated animate__backInUp mr-2"> Hi, I am Nazrul Islam. I am running 26. I am from aristocratic muslim family. I am doing BSC on the
                        department of CSE Computer 'Science and Engineering'. Right now, I am also a student of <span className='text-red-500'>Programming Hero</span> where I am
